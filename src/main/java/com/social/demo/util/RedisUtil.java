...
public class RedisUtil {
   ...
   public Boolean setObject(String key,Object object,Long timeout){
      stringRedisTemplate.opsForValue().set(key, JsonUtil.object2StringSlice(object),timeout, TimeUnit.SECONDS);
      return true;
   }
   ...
   public Boolean setObject(String key,Object object){
      stringRedisTemplate.opsForValue().set(key,JsonUtil.object2StringSlice(object));
      return true;
   }
    ...
    * @return
    */
   public <T> T getObject(String key,Class<T> cls) throws IOException {
      return JsonUtil.deserialize(stringRedisTemplate.opsForValue().get(key),cls);
   }
